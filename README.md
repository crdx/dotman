...
A machine's hostname is used to selectively symlink dotfiles. The `only` and `except` directives can restrict or exclude machines from the operation, respectively.
